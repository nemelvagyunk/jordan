...
export const Permissions = [
  ...
  { name: 'meters.registerReading', roles: ['manager'] },
  { name: 'meters.registerReading.unapproved', roles: ['owner@parcel', 'benefactor@parcel'] },
  { name: 'meters.remove',          roles: ['manager'] },
  { name: 'meters.upsert',          roles: ['manager'] },
  { name: 'meterReadings.insert',   roles: ['manager', 'maintainer'] },
  { name: 'meterReadings.update',   roles: ['manager', 'maintainer'] },
  { name: 'meterReadings.remove',   roles: ['manager', 'maintainer'] },
  { name: 'meterReadings.upsert',   roles: ['manager', 'maintainer'] },
  ...
  { name: 'deals.propose',           roles: nobody, allowAuthor: true },
